...
python /global/home/users/rohitkolora/local_modules_sw/salsa/2.2/run_pipeline.py -a ${reference_fasta} -c 1000 -o ${naming}/scaffolding -l ${reference_fasta}.fai -e DNASE -i 3 -b ${naming}/deduplicated/repli.bed -m yes 1>>${naming}/LOG 2>>${naming}/LOG
