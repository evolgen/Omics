...
infile=$(echo $file1 | sed -e 's/mafs/seqs/' -e 's/\.maf/.fa/')
file2=$(echo $file1 | sed -e 's/mod_mafs/check_gffs/' -e 's/\.maf/.gff/')
file3=$(echo $file2 | sed -e 's/check_gffs/check_cons_codons_ss/' -e 's/\.gff/.codons.ss/')
file4=$(echo $file3 | sed -e 's/check_cons_codons_ss/check_cons_sites_ss/' -e 's/\.ss/.sites.ss/')
