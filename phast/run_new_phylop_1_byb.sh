...
file2=$(echo $file1 | sed -e 's/new_Chunks/new_phylop_elements_bb/' -e 's/\..*/.base-scores.wig/')
...
phyloP --wig-scores --base-by-base --method SCORE --mode CONACC Lacerta_init.mod --msa-format SS $file1 >$file2
