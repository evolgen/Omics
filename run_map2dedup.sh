...
#for file1 in /global/scratch/rohitkolora/Rockfish/Genomes/sequencing/illumina/fastq/Sebastes_[b-mo-z]*/*/*_R1_001.fastq.gz; do
for file1 in /global/scratch/rohitkolora/Rockfish/Genomes/sequencing/illumina/fastq/Sebast*/*/*_R1_001.fastq.gz; do
    ...
    if [ ! -e "dedup.bam" ]; then
        ...
        /global/scratch/rohitkolora/Software/gatk-4.1.2/gatk \
            --java-options "-Xmx380G" MarkDuplicates \
