...
\ls -d /global/scratch2/rohitkolora/Rockfish/Genomes/codeml/sequence_files/OrthoGroup*/short/null.codeml.short.out | 
    while read nullmodel; do 
        ...
        altmodel=$(echo $nullmodel | sed -e 's/null.codeml.short.out/alt.codeml.short.out/'); 
