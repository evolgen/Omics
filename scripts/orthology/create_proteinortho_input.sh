...
if [ ! -e "files_crossprot2aug.lst"]; then
    \ls -d /global/scratch2/rohitkolora/Rockfish/Genomes/sequencing/illumina/output/*/*/assembly/masurca/FILTERED/CROSSPROT/crossprot2aug.norepeats.CDS.gff /global/scratch2/rohitkolora/Rockfish/Genomes/FREEZE/*/*/FILTERED/CROSSPROT/crossprot2aug.norepeats.CDS.gff >files_crossprot2aug.lst
fi

mkdir -p input_data;
cat files_crossprot2aug.lst | while read file1; do 
