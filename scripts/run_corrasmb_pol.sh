...
for count in `seq 0 5`; do
  ...
  version=$((count+1))
  ~/local_modules_sw/minimap2/2.15/minimap2 -t 32 -x map-pb -a $name.V${count}.ctg.fa /global/scratch2/rohitkolora/Rockfish/Genomes/sequencing/pacbio/S_umbrosus/01.25.2019/SEB10_Cell1/m54050R1_181211_022522.subreads.fastq.gz /global/scratch2/rohitkolora/Rockfish/Genomes/sequencing/pacbio/S_umbrosus/01.25.2019/SEB10_Cell2/m54050R1_181212_232858.subreads.fastq.gz /global/scratch2/rohitkolora/Rockfish/Genomes/sequencing/pacbio/S_umbrosus/01.25.2019/SEB10_Cell3/m54050R1_181213_094204.subreads.fastq.gz /global/scratch2/rohitkolora/Rockfish/Genomes/sequencing/pacbio/S_umbrosus/01.25.2019/SEB10_Cell4/m54290_190124_022926.subreads.fastq.gz | samtools view -Sb - >$name.ctg.map.bam;
