...
run-asm-pipeline.sh -q 20 --editor-coarse-resolution 2500000 --editor-coarse-region 12500000 --editor-fine-resolution 100000 -i 1000 ${reference} ../aligned/merged_nodups.txt 1>>../LOG 2>>../LOG;
