...
for file1 in ./S*/*_1.fastq.gz; do
  ...
  echo fastp --trim_poly_g --detect_adapter_for_pe --overrepresentation_analysis --html ${filename}.html -j ${filename}.json --thread 20 --length_required 35 --correction --overlap_diff_limit 2 --trim_poly_x --disable_quality_filtering --n_base_limit 1 --in1 $file1 --in2 $file2 --out1 ${file1}.adptrm --out2 ${file2}.adptrm
