...
#10,11,12			14,15,16
			...
			print $outQuery $thisline[9],"\t",$QueryStart,"\t",$QueryEnd,"\t",$thisline[10],"\t",$thisline[13],"\t+\t",$InsertsizeQ,"\t",$InsertsizeT,"\n";
			print $outTarget $thisline[13],"\t",$TargetStart,"\t",$TargetEnd,"\t",$thisline[14],"\t",$thisline[9],"\t+\t",$InsertsizeT,"\t",$InsertsizeQ,"\n";
			}
