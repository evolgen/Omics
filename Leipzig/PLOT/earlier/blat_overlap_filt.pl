...
#10,11,12			14,15,16
			...
			if ($thisline[9] ~ $thisline[9])			{
			print $outQuery $thisline[9],"\t",$QueryStart,"\t",$QueryEnd,"\t",$thisline[9],"_",$thisline[10],"+",$blocknumber,":",$InsertsizeQ,"\t",$thisline[13],":",$InsertsizeT,"\t+\t",$InsertsizeQ,"\t",$InsertsizeT,"\n";
			print $outTarget $thisline[13],"\t",$TargetStart,"\t",$TargetEnd,"\t",$thisline[13],"_",$thisline[14],"+",$blocknumber,":",$InsertsizeT,"\t",$thisline[9],":",$InsertsizeQ,"\t+\t",$InsertsizeT,"\t",$InsertsizeQ,"\n";
			}
			}
