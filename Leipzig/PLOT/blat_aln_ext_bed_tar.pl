...
##			print $outQuery $thisline[9],"\t",$QueryStart,"\t",$QueryEnd,"\t",$thisline[10],"\t",$thisline[13],"\t+\t",$thisline[9],"+",$blocknumber,":",$AlignsizeQ,"\t",$thisline[13],":",$AlignsizeT,"\t",$AlignsizeQ,"\t",$AlignsizeT,"\n";
			print $outTarget $thisline[13],"\t",$TargetStart,"\t",$TargetEnd,"\t",$thisline[14],"\t",$thisline[13],"+",$blocknumber,":",$AlignsizeT,"\t+\t",$thisline[9],"\t",$QueryStart,"\t",$QueryEnd,"\t",$thisline[10],"\t",$linenumber,"_#_",$Line_count,"\t",$AlignsizeT,"\t",$AlignsizeQ,"\n";
			}
