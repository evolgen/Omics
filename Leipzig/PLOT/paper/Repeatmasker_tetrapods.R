...
#  scale_size_manual(values = c(0.1,1,0.75,0.9,1.5,0.7)) +
  ...
  annotate(geom = 'text', x = 8, y = 0.94, hjust = 0.35, vjust = -1.2, label = 'L. viridis', fontface = 'bold.italic') +
  annotate(geom = 'text', x = 9, y = 0.94, hjust = 0.65, vjust = -1.18, label = 'L. bilineata', fontface = 'bold.italic') +
