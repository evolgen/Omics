...
#perl N50Stat.pl -i file.fa -o out.txt
...
my $n20 = calcN50(\@len, 20);
my $n25 = calcN50(\@len, 25);
my $n30 = calcN50(\@len, 30);
my $n40 = calcN50(\@len, 40);
my $n50 = calcN50(\@len, 50);
my $n60 = calcN50(\@len, 60);
my $n70 = calcN50(\@len, 70);
my $n75 = calcN50(\@len, 75);
my $n80 = calcN50(\@len, 80);
my $n90 = calcN50(\@len, 90);
my $n95 = calcN50(\@len, 95);
my $n100 = calcN50(\@len, 100);
