...
#Extract sequences with minimum length 30 and maximum length 60
perl Seq_filter.pl -i INPUT.TXT -min 30 -max 60


#Cut the end of the sequence and save to file sequences_ok.fas file
perl Seq_filter.pl -i INPUT.TXT -min 30 -max 60 -1


#Remove sequences and write to output file sequences_too_long.fas then my command will be 
perl Seq_filter.pl -i INPUT.TXT -min 30 -max 60 -0


#Many files with thousand of sequences, write the name of those file(one file name per line) in a text file (file_name.txt)
perl length_cutoff.pl -I file_name.txt -min 30 -max 60



#Combined Command
perl Seq_filter.pl -i INPUT.TXT -I file_name.txt -min 30 -ma
