...
conda activate gatk
printf "\tRunning GATK for duplicates\n";
/global/scratch/rohitkolora/Software/gatk-4.1.2/gatk --java-options "-Xmx100G" MarkDuplicates --TMP_DIR $PWD --INPUT ${reference}.sort2.bam --OUTPUT ${bam2} --METRICS_FILE ${bam2}.metrics --MAX_FILE_HANDLES 15000;
