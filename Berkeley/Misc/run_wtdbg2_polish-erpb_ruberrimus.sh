...
wtdbg2 -p 21 -K 800.010010 -A -S 1.000000 -s 0.050000 -g 1g -e 3 -L 5000 -X 50 -o ruberrimus_wtdbg2_001.V0 -i /global/scratch/rohitkolora/Rockfish/Genomes/sequencing/pacbio/S_ruberrimus/04.29.2019/ruberrimus_pacbio.fastq.gz 1>ruberrimus_wtdbg2_001.LOG 2>>ruberrimus_wtdbg2_001.LOG
...
for count in `seq 0 5`; do
  ...
  version=$((count+1))
  ~/local_modules_sw/minimap2/2.15/minimap2 -t 32 -k 19 -w 10 -a ruberrimus_wtdbg2_001.V${count}.ctg.fa /global/scratch/rohitkolora/Rockfish/Genomes/sequencing/pacbio/S_ruberrimus/04.29.2019/ruberrimus_canu.correctedReads.fasta.gz >sam.sam;
