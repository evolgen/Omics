...
python /global/home/users/rohitkolora/local_modules_sw/salsa/2.2/run_pipeline.py -a ${reference_fasta} -c 1000 -o scaffolds -l ${reference_fasta}.fai -e DNASE -i 3 -b ./deduplicated/repli.bed -m yes 1>>LOG 2>>LOG
